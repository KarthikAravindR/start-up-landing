            ...
            <div className={classes.approachWaysContainer}>
                ...
                <div className={classes.approachWays}>
                    <div className={classes.approachWayselements}>
                        <div className={classes.approachWaysImageDiv}><img src={research} alt="" /></div>
                    </div>
                    <div className={classes.approachWayselements}>
                        <div>01/05</div>
                ...
                <div className={classes.approachWays}>
                    ...
                    <div className={classes.approachWayselements}>
                        <div className={classes.approachWaysImageDiv}><img src={wireframe} alt="" /></div>
                    </div>
                </div>

                <div className={classes.approachWays}>
                    <div className={classes.approachWayselements}>
                        <div className={classes.approachWaysImageDiv}><img src={design} alt="" /></div>
                    </div>
                    <div className={classes.approachWayselements}>
                        <div>03/05</div>
                        <h1>Visual Design</h1>
                ...
                <div className={classes.approachWays}>
                    ...
                    <div className={classes.approachWayselements}>
                        <div className={classes.approachWaysImageDiv}><img src={development1} alt="" /></div>
                    </div>
                </div>

                <div className={classes.approachWays}>
                    <div className={classes.approachWayselements}>
                        <div className={classes.approachWaysImageDiv}><img src={testing} alt="" /></div>
                    </div>
                    <div className={classes.approachWayselements}>
                        <div>05/05</div>
